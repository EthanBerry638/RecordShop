...
namespace RecordShop.Tests.Unit.ServiceTests
{
    public class AlbumServiceTests
    {
        ...
        [Test]
        // 256 chars
        [TestCase("", "")]
        public async Task PostAlbumAsync_ShouldThrowException_WhenStringsLongerThan255Chars(string title, string artist)
        {
            var testDTO = new PostAlbumRequestResponse(title, artist, 2);
